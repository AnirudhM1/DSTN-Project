...
class KafkaServer:
    ...
    def start_zookeeper(self):
        ...
        with open(self.zookeeper_stdout, 'w') as stdout, open(self.zookeeper_stderr, 'w') as stderr:
            try:
                subprocess.run(
                    [
    ...
    def start_kafka(self):
        ...
        with open(self.kafka_stdout, 'w') as stdout, open(self.kafka_stderr, 'w') as stderr:
            try:
                subprocess.run(
                    [
                        'bash', start_script_path, config_path
